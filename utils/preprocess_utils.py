    ...
    def __init__(self, params, device):
        ...
        if self.params.add_landmask:
            with torch.no_grad():
                ...
                # one hot encode and move channels to front (2, 721, 1440)
        ...
        if self.params.add_orography:
            with torch.no_grad():
                # get lsm (721, 1440) and reshape to (1, 1, 721, 1440)
                ...
                if static_features is None:
                    ...
                    static_features = torch.cat([static_features, oro], dim=1)  # (1, 3, 721, 1440)
